...
import { computeBingoCount, extractBingoPersonInput, getBingoHoleValues, normalizeBingoSelectedHoles } from '../../events/bingo';
...
export default function BingoSelectionMonitor({
  ...
  }, [participants, inputsByEvent, roomNames, selectedHoles]);
